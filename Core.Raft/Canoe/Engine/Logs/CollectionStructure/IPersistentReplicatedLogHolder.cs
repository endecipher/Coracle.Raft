...
namespace Core.Raft.Canoe.Engine.Logs.CollectionStructure
{
    /// <summary>
    ...
    public interface IPersistentReplicatedLogHolder 
    {
        ...
        /// <summary>
        /// All Entries from the <paramref name="index"/> (Inclusive) are deleted.
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
        [Obsolete]
        Task DeleteAllEntriesStartingFromIndex(long index);
        ...
        /// <summary>
        /// Fetches the LogEntries from [startIndex, endIndex]
        /// </summary>
