...
namespace Core.Raft.Canoe.Engine.Remoting
{
    ...
    public interface IRemoteManager
    {
        ...
        ///// <summary>
        ///// Extension to forward the Configuration Change Request to the Leader.
        ///// </summary>
        ///// <param name="info"></param>
        ///// <returns></returns>
        //Task<ConfigurationChangeResult> ForwardToLeader(ConfigurationChangeRPC rpc, INodeConfiguration configuration, CancellationToken cancellationToken);
    }
}
