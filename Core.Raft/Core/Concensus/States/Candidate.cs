namespace Rafty.Concensus.States
{
    ...
    public sealed class Candidate : IState
    {
        ...
        private List<Task> GetVotes(BlockingCollection<RequestVoteRPCResponse> requestVoteResponses)
        {
        ...
        private async Task CountVotes(BlockingCollection<RequestVoteRPCResponse> requestVoteResponses)
        {
        ...
        private async Task CountVote(RequestVoteRPCResponse requestVoteResponse)
        {
        ...
        private bool ResponseContainsTermGreaterThanCurrentTerm(RequestVoteRPCResponse requestVoteResponse)
        {
            return requestVoteResponse.Term > CurrentState.CurrentTerm;
        }

        private void BecomeFollowerAfterElectionFinishes(RequestVoteRPCResponse requestVoteResponse)
        {
        ...
        private async Task RequestVote(IPeer peer, BlockingCollection<RequestVoteRPCResponse> requestVoteResponses) 
        {
        ...
        private void AppendEntriesTermIsGreaterThanCurrentTerm(AppendEntriesRPC appendEntries)
        {
        ...
        private (RequestVoteRPCResponse requestVoteResponse, bool shouldReturn) RequestVoteTermIsGreaterThanCurrentTerm(RequestVote requestVote)
        {
        ...
        private async Task<(RequestVoteRPCResponse requestVoteResponse, bool shouldReturn)> LastLogIndexAndLastLogTermMatchesThis(RequestVote requestVote)
        {
        ...
        private void SetLeaderId(AppendEntriesRPC appendEntries)
        {
        ...
        {
            var requestVoteResponses = new BlockingCollection<RequestVoteRPCResponse>();
